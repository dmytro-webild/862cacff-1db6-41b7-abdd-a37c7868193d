...
export default function LandingPage() {
      ...
      testimonials={[
        {
          name: "Sarah O.",
          handle: "@sarah_o",
          testimonial: "Excellent service and genuine phones at great prices.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-smiley-man-work_23-2149546182.jpg",
        },
        {
          name: "John K.",
          handle: "@john_k",
          testimonial: "Bought my laptop here, absolutely professional staff.",
          rating: 5,
        ...
        },
        {
          name: "Mercy A.",
          handle: "@mercy_a",
          testimonial: "Jubba Shop is my go-to for all my office electronics.",
          rating: 5,
        ...
        },
        {
          name: "David M.",
          handle: "@david_m",
          testimonial: "Trustworthy and reliable store. Fast support.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-young-male-student-carrying-bag-shoulder-books-hand-standing-against-red-wall_23-2148093325.jpg",
        },
        {
          name: "Faith B.",
          handle: "@faith_b",
          testimonial: "High quality gadgets, would highly recommend to everyone.",
          rating: 5,
      ...
      avatars={[
        {
          ...
          alt: "Teleworker at home office editing documents",
        },
        {
          src: "http://img.b2bpic.net/free-photo/happy-handsome-young-african-american-businessman-dressed-shirt_273609-9150.jpg",
          alt: "Happy handsome young African-American businessman",
        },
        {
          src: "http://img.b2bpic.net/free-photo/happy-dark-skinned-male-freelancer-uses-modern-electronic-gadgets-remote-work-sits-against-cozy-coffee-shop-interior-drinks-aromatic-espresso_273609-3449.jpg",
          alt: "Happy dark skinned male freelancer",
        },
        {
          src: "http://img.b2bpic.net/free-photo/african-american-business-man-using-laptop-cafe_1303-15076.jpg",
          alt: "African american business man using laptop",
        },
        {
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        ...
        },
        {
          ...
          alt: "Jubba Shop Electronics Store",
        },
        {
          type: "text",
          content: " Electronics Partner in Kenya",
        },
      ]}
      buttons={[
        {
      ...
      features={[
        {
          ...
          description: "100% genuine products directly sourced.",
          imageSrc: "http://img.b2bpic.net/free-photo/many-different-smart-phones-displayed-dark-background-busy-office-scene_1372-28.jpg",
        },
        {
          tag: "Audio",
          title: "Premium Audio",
          subtitle: "Top brand gear",
          description: "Crystal clear sound with our latest range.",
          imageSrc: "http://img.b2bpic.net/free-photo/headphones-near-crop-amplifier_23-2147781796.jpg",
        },
        {
          tag: "Compute",
          title: "High Performance",
          subtitle: "Computing power",
          description: "Reliable laptops for work and school.",
      ...
      products={[
        {
          ...
          rating: 5,
          reviewCount: "12",
          imageSrc: "http://img.b2bpic.net/free-photo/father-s-day-composition-with-mobile-phone-other-elements_23-2147632048.jpg",
        },
        {
          id: "p2",
          brand: "AudioTech",
          ...
          rating: 4,
          reviewCount: "8",
          imageSrc: "http://img.b2bpic.net/free-photo/performer-putting-forefinger-lips-gesturing-secrecy-sign-while-performing-electronic-music-studio-pink-background-musical-artist-playing-sounds-produce-melody-mixer-console_482257-60923.jpg",
        },
        {
          id: "p3",
          brand: "PadTech",
          ...
          rating: 5,
          reviewCount: "15",
          imageSrc: "http://img.b2bpic.net/free-photo/chef-with-tablet_23-2148145647.jpg",
        },
        {
          id: "p4",
          brand: "WatchCo",
        ...
        },
        {
          ...
          rating: 5,
          reviewCount: "10",
          imageSrc: "http://img.b2bpic.net/free-photo/woman-wearing-headphones-looking-christmas-lights_23-2148397182.jpg",
        },
      ]}
  ...
  <div id="pricing" data-section="pricing">
      ...
      plans={[
        ...
        {
          id: "ultimate",
          title: "Ultimate Peace",
          price: "KSh 5,000",
          period: "/year",
          features: [
            "Everything in Premium",
            "Device replacement option",
            "24/7 expert remote help",
          ],
          button: {
            text: "Select Plan",
          },
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          id: "t2",
          name: "John K.",
          imageSrc: "http://img.b2bpic.net/free-photo/entrepreneur-working-home-office-desk-laptop-writing-notebook_482257-114440.jpg",
        },
        {
          id: "t3",
          name: "Mercy A.",
